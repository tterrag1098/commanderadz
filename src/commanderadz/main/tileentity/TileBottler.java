...
public class TileBottler extends TileEntity implements IInventory {
	...
	public void pressItem() {
		if (this.inventory[0] != null && this.inventory[1] != null) {
			ItemStack var1 = BottlerRecipies.instance().getRecipeResult(
					this.inventory[0].getItem().itemID,
					this.inventory[1].getItem().itemID);
	...
	public boolean canPress() {
		...
		ItemStack itemstack = BottlerRecipies.instance().getRecipeResult(
				inventory[0].getItem().itemID, inventory[1].getItem().itemID);
