...
public class ItemRedDrink extends Item {
    public ItemRedDrink(int id){
        super(id);
        setUnlocalizedName("reddrink");
    ...
    public ItemStack onEaten(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer)
    {
        ...
        {
            par3EntityPlayer.addPotionEffect(new PotionEffect(Potion.nightVision.id, 3600, 1, true));
        }
